...
const shortenerResponse = (isValidUrl, serverMessage) => {
    ...
    if (isValidUrl) {
        ...
        urlAlert.classList.remove('custom-alert-danger')
        urlAlert.classList.add('alert-success')
        urlAlert.classList.add('custom-alert-success')
        ...
        message = `
            ...
            <span class="iconify" data-icon="si-glyph:clipboard" data-inline="false"></span>
            <button class="btn btn-short btn-sm btn-copy" id="btn-copy-link">Copy</button>
            <span class="d-none copied-label" id="copied">Copied</span>
            
        `
    } else {
        urlAlert.classList.remove('alert-success')
        urlAlert.classList.remove('custom-alert-success')
        urlAlert.classList.add('alert-danger')
        urlAlert.classList.add('custom-alert-danger')
        urlAlert.classList.remove('invisible')
